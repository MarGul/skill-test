                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center">
                                            <input id="default-radio-2" type="radio" v-model="form.in_stock"
                                    ...
                                    <div>
                                        ...
                                        <div
                                            class="mt-1 text-sm text-red-500"
                                            v-if="errors.categoriesIds"
                                        >
                                            {{ errors.categoriesIds[0] }}
                                        </div>
                                    </div>
                                </div>
                                <div
...
<script setup>
    ...
    const form = useForm({
        ...
        categoriesIds: props.product.categories_ids,
    });
    const photoPreview = ref(props.product.image_url);
