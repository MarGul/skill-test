								...
								<div class="px-4 py-5 bg-white space-y-6 sm:p-6">
									...
									<div>
										<label for="product-in-stock"
										       class="block text-sm font-medium text-gray-700">In stock</label>
										<div class="mt-1">
											<input type="checkbox" v-model="form.inStock" id="product-in-stock"
											       :class="{'border-red-500': errors?.inStock, 'border-gray-300': !errors?.inStock}"
											       class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block sm:text-sm border rounded-md"
											       placeholder="Price">
										</div>
										<p class="mt-2 text-sm text-gray-500">Brief in stock for the product.</p>
									</div>
