		...
		<div class="max-w-7xl mx-auto mt-8 sm:px-6 lg:px-8">
							...
							<div class="px-4 py-4 flex items-center sm:px-6">
								<div class="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
									<div class="truncate flex">
										<div v-if="product.image" :style="`background-image: url('/${product.image}')`" class="product-table-image mr-2">
										</div>
										<div>
											...
											<div class="flex text-sm">
												<p class="font-medium truncate" v-text="product.category.title"/>
											</div>
											<div class="mt-2 flex">
			...
			<div v-else class="bg-white shadow overflow-hidden sm:rounded-md mt-3">
				<Link :href="route('products.create')"
					...
					<span class="mt-2 block text-sm font-medium text-gray-900"> Create a new product </span>
				</Link>
			</div>
		</div>
	</main>
