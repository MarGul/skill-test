<template>
	<header>
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between">
			<h1 class="text-3xl font-bold leading-tight text-gray-900">View categories</h1>
			<Link v-if="props.categories.length > 0"
	...
	<main>
		<div class="max-w-7xl mx-auto mt-8 sm:px-6 lg:px-8">
			<div v-if="props.categories.length > 0" class="bg-white shadow overflow-hidden sm:rounded-md">
