<template>
    <div class="max-w-7xl mx-auto mt-8 sm:px-6 lg:px-8 notifications">
        <div v-if="$page.props.flash.success && show" class="flex items-center justify-between bg-green-500 rounded">
        ...
        <div v-if="$page.props.flash.warning && show" class="flex items-center justify-between bg-yellow-500 rounded">
            <div class="flex items-center">
                <svg class="ml-4 mr-2 flex-shrink-0 w-4 h-4 fill-white" xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 20 20">
                    <polygon points="0 11 2 9 7 14 18 3 20 5 7 18"/>
        ...
        <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show"
             class="flex items-center justify-between bg-red-500 rounded">
            <div class="flex items-center">
                <svg class="ml-4 mr-2 flex-shrink-0 w-4 h-4 fill-white" xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 20 20">
                    <path
